...
function PortfolioContent() {
  ...
  const projects = [
    ...
    {
      title: 'Landing Page',
      desc: 'Landing page responsiva con un diseño moderno, animaciones suaves y componentes reutilizables.',
      image: 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwyfHxkZXNpZ258ZW58MHx8fHwxNjgzNjM4ODcz&ixlib=rb-4.0.3&q=80&w=1080',
      github: 'https://github.com/Alejandro20202/Landing-Page.git',
      demo: 'https://landing-page-eight-sigma-66.vercel.app/'
    }
  ];
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br ${themeClasses.bg} ${theme === 'dark' ? 'text-white' : 'text-slate-900'}`}>
      ...
      <section id="inicio" className="min-h-screen flex items-center justify-center pt-16 px-4">
        <div className="max-w-7xl mx-auto w-full grid md:grid-cols-[minmax(0,1fr)_minmax(16rem,22rem)] gap-2 items-center">
          <motion.div
          ...
          >
            <div className={`relative w-64 h-64 sm:w-80 sm:h-80 rounded-[2.5rem] p-2 bg-gradient-to-tr ${themeClasses.progress} shadow-[0_0_80px_rgba(99,102,241,0.24)] overflow-hidden group`}>
              <div className="absolute inset-0 rounded-[2.5rem] bg-white/10 blur-2xl opacity-60 pointer-events-none" />
              <div className="absolute inset-0 rounded-[2.5rem] border border-white/10 shadow-[0_0_40px_rgba(99,102,241,0.32)] pointer-events-none" />
              <div className="relative w-full h-full rounded-[2.15rem] overflow-hidden border border-white/10 bg-slate-950/10 backdrop-blur-sm z-10 shadow-[inset_0_0_50px_rgba(255,255,255,0.1)]">
                <img
                  src={profileImage}
            ...
            <div className="mb-10">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                {[
                  ...
                  { name: 'JavaScript', icon: <div className="w-8 h-8 flex items-center justify-center rounded-full bg-[#F7DF1E] text-black font-black text-[10px] tracking-[0.12em]">JS</div>, color: 'from-yellow-400 to-orange-500' },
                  { name: 'TypeScript', icon: <div className="w-8 h-8 flex items-center justify-center rounded-full bg-[#3178C6] text-white font-black text-[10px] tracking-[0.12em]">TS</div>, color: 'from-blue-600 to-blue-700' },
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className={`font-medium ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>{t.footer.name}</div>
                  </div>
                </motion.a>
              </div>
